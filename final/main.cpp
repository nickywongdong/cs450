...
InitLists( )
{
	...
	//downloading texture and making it current texture
	glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
	glTexImage2D(GL_TEXTURE_2D, level, ncomps, texWidth[0], texHeight[0], border, GL_RGB, GL_UNSIGNED_BYTE, tex1);
	//glTranslatef(0., 0., 0.);
	...
	glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
	glTexImage2D(GL_TEXTURE_2D, level, ncomps, texWidth[1], texHeight[1], border, GL_RGB, GL_UNSIGNED_BYTE, tex2);
	//glTranslatef(0., 0., 0.);
	...
	//downloading texture and making it current texture
	glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
	glTexImage2D(GL_TEXTURE_2D, level, ncomps, texWidth[2], texHeight[2], border, GL_RGB, GL_UNSIGNED_BYTE, tex3);
	//glTranslatef(0., 0., 0.);
	...
	//downloading texture and making it current texture
	glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
	glTexImage2D(GL_TEXTURE_2D, level, ncomps, texWidth[3], texHeight[3], border, GL_RGB, GL_UNSIGNED_BYTE, tex4);
	//glTranslatef(0., 0., 0.);
	...
	//downloading texture and making it current texture
	glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
	glTexImage2D(GL_TEXTURE_2D, level, ncomps, texWidth[4], texHeight[4], border, GL_RGB, GL_UNSIGNED_BYTE, tex5);
	//glTranslatef(0., 0., 0.);
	...
	//downloading texture and making it current texture
	glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
	glTexImage2D(GL_TEXTURE_2D, level, ncomps, texWidth[5], texHeight[5], border, GL_RGB, GL_UNSIGNED_BYTE, tex6);
	//glTranslatef(0., 0., 0.);
